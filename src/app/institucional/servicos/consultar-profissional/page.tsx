...
export default function Page() {
  const [profissional, setProfissional] = useState<Profissional | undefined>(
    undefined,
  );
  ...
  return (
    <main className="flex flex-col items-center max-w-4xl mx-auto">
      ...
      <p className="mt-4 mb-8">
        Encontre um profissional registrado na base de dados do CONFEA
      </p>
      ...
      <ProfissionalDialog
        onClose={onCloseProfissionalDialog}
