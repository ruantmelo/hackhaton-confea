     ...
     <div className='grid grid-cols-3 flex-wrap md:grid-cols-[repeat(3,_minmax(120px,_300px))] gap-6 '>
        ...
        <Card className="pt-4">
          <CardContent className='flex flex-col justify-center items-center cursor-not-allowed text-primary'>
            ...
            <span className='text-xs text-center sm:text-base md:text-lg'>Registros Pendentes</span>
          </CardContent>
        </Card>
        <Card className="pt-4">
          <CardContent className='flex flex-col justify-center items-center cursor-not-allowed text-primary'>
            <LuAlertTriangle className="text-5xl sm:text-6xl md:text-8xl" />
            <span className='text-xs text-center sm:text-base md:text-lg'>Visulizar Denúncias</span>
          </CardContent>
        </Card>
        <Card className="pt-4">
          <CardContent className='flex flex-col justify-center items-center cursor-not-allowed text-primary'>
            <LuUsers className="text-4xl sm:text-6xl md:text-8xl" />
            <span className='text-xs text-center sm:text-base md:text-lg'>Ver Profissionais</span>
          </CardContent>
        </Card>
     </div>
  </>
